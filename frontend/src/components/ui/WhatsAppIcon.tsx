/**
 * Logo oficial de WhatsApp (glifo) como SVG, para usar en botones de contacto.
 * Se dibuja en color blanco por defecto sobre el botón verde de marca (#25D366).
 */
...
export function WhatsAppIcon({ size = 22, color = '#FFFFFF' }: WhatsAppIconProps): React.ReactElement {
  return (
