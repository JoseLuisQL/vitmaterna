...
const styles = StyleSheet.create({
  ...
  favBtn: { width: 40, height: 40, alignItems: 'center', justifyContent: 'center', borderRadius: 20, backgroundColor: commonColors.onColorSurface },
  headerIcon: { width: 56, height: 56, borderRadius: 28, backgroundColor: commonColors.onColorSurfaceStrong, alignItems: 'center', justifyContent: 'center', marginTop: spacing.md },
  category: { ...typography.overline, color: commonColors.onColorTextStrong, textTransform: 'uppercase', letterSpacing: 0.8, marginTop: spacing.md },
  ...
  metaChip: { flexDirection: 'row', alignItems: 'center', gap: 5, backgroundColor: commonColors.onColorSurface, borderRadius: borderRadius.full, paddingHorizontal: 10, paddingVertical: 5 },
