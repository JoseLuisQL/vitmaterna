...
const styles = StyleSheet.create({
  ...
  profileRole: { ...typography.bodySm, color: commonColors.onColorTextSoft },
  profileDni: { ...typography.caption, color: commonColors.onColorTextFaint, marginTop: spacing.xs },
  syncChip: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 6,
