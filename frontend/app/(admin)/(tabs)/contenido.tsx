...
import {
  View, StyleSheet, Text, ScrollView, FlatList, TouchableOpacity, RefreshControl, Switch, TextInput, Image, ActivityIndicator, Platform, StatusBar,
} from 'react-native';
...
const styles = StyleSheet.create({
  ...
  headerGradient: { borderBottomLeftRadius: borderRadius.xxxl, borderBottomRightRadius: borderRadius.xxxl, paddingBottom: spacing.md, ...shadows.float },
  header: { flexDirection: 'row', alignItems: 'center', gap: spacing.md, paddingHorizontal: spacing.lg, paddingVertical: spacing.md, paddingTop: Platform.OS === 'android' ? (StatusBar.currentHeight || 0) + spacing.md : spacing.xl },
  menuBtn: { width: 48, height: 48, borderRadius: 24, backgroundColor: 'rgba(255,255,255,0.2)', alignItems: 'center', justifyContent: 'center' },
  title: { ...typography.display, color: commonColors.white, fontSize: 26 },
  subtitle: { ...typography.bodyMd, color: commonColors.onColorTextSoft, marginTop: 4, fontWeight: '500' },
  addBtn: { width: 48, height: 48, borderRadius: 24, backgroundColor: 'rgba(255,255,255,0.2)', alignItems: 'center', justifyContent: 'center' },
  ...
  list: { padding: spacing.lg, paddingTop: spacing.md, paddingBottom: layout.tabBarSpace },
  ...
  // Vista previa
  previewCover: { width: '100%', height: 150, borderRadius: borderRadius.xl, backgroundColor: commonColors.surfaceAlt, marginBottom: spacing.md },
  ...
  previewCat: { ...typography.overline, fontWeight: '800' },
  previewTitle: { ...typography.display, color: commonColors.text, marginBottom: spacing.xs },
  previewMeta: { ...typography.bodySm, color: commonColors.textSecondary },
  card: {
    flexDirection: 'row', alignItems: 'center', gap: spacing.md,
    backgroundColor: commonColors.surface, borderRadius: borderRadius.xl,
    padding: spacing.lg, marginBottom: spacing.sm2, borderWidth: 1, borderColor: commonColors.borderLight, ...shadows.subtle,
  },
  cardIcon: { width: 48, height: 48, borderRadius: 16, backgroundColor: adminColors.primaryLight, alignItems: 'center', justifyContent: 'center' },
  cardTitle: { ...typography.h3, color: commonColors.text, marginBottom: 4 },
  cardMeta: { flexDirection: 'row', flexWrap: 'wrap', gap: 8, marginTop: 6 },
  tag: { backgroundColor: commonColors.surfaceAlt, borderRadius: borderRadius.full, paddingHorizontal: 10, paddingVertical: 4 },
  tagText: { ...typography.label, color: commonColors.textSecondary, letterSpacing: 0, fontWeight: '600' },
  tagInactive: { backgroundColor: semanticColors.dangerLight },
  tagInactiveText: { ...typography.label, color: semanticColors.danger, letterSpacing: 0, fontWeight: '800' },
  iconBtn: { width: 40, height: 40, alignItems: 'center', justifyContent: 'center', backgroundColor: commonColors.surfaceAlt, borderRadius: 20 },
  label: { ...typography.label, color: commonColors.textSecondary, marginBottom: spacing.sm, marginTop: spacing.md },
  chipsWrap: { flexDirection: 'row', flexWrap: 'wrap', gap: spacing.sm },
  chip: { paddingHorizontal: spacing.md, paddingVertical: 10, borderRadius: borderRadius.full, backgroundColor: commonColors.surfaceAlt, borderWidth: 1, borderColor: commonColors.border },
  chipActive: { backgroundColor: BRAND, borderColor: BRAND, ...shadows.subtle },
  chipText: { ...typography.label, color: commonColors.textSecondary, fontWeight: '600' },
  chipTextActive: { color: commonColors.white, fontWeight: '800' },
  searchBox: { marginBottom: spacing.md },
  filterRow: { gap: spacing.sm, paddingBottom: spacing.lg },
  filterChip: { paddingHorizontal: spacing.lg, paddingVertical: 10, borderRadius: borderRadius.full, backgroundColor: commonColors.surface, borderWidth: 1, borderColor: commonColors.border, ...shadows.subtle },
  filterChipActive: { backgroundColor: BRAND, borderColor: BRAND, ...shadows.card },
  filterChipText: { ...typography.label, fontWeight: '600', color: commonColors.textSecondary },
  filterChipTextActive: { color: commonColors.white, fontWeight: '800' },
  switchRow: { flexDirection: 'row', alignItems: 'center', marginTop: spacing.lg, paddingTop: spacing.md, borderTopWidth: 1, borderTopColor: commonColors.borderLight },
  switchLabel: { ...typography.h3, color: commonColors.text, fontWeight: '700' },
  switchHint: { ...typography.bodySm, color: commonColors.textSecondary, marginTop: 2 },
  thumbPicker: { height: 160, borderRadius: borderRadius.xl, backgroundColor: commonColors.surfaceAlt, borderWidth: 1, borderColor: commonColors.border, borderStyle: 'dashed', overflow: 'hidden', alignItems: 'center', justifyContent: 'center' },
  thumbPreview: { width: '100%', height: '100%' },
  thumbPlaceholder: { alignItems: 'center', gap: 8 },
  thumbPlaceholderText: { ...typography.bodySm, color: commonColors.textSecondary, fontWeight: '600' },
  thumbRemove: { flexDirection: 'row', alignItems: 'center', gap: 6, alignSelf: 'flex-start', marginTop: spacing.sm },
  thumbRemoveText: { ...typography.label, color: semanticColors.danger, fontWeight: '600' },
  uploadMediaBtn: { flexDirection: 'row', alignItems: 'center', gap: 6, alignSelf: 'flex-start', marginTop: spacing.sm },
  uploadMediaText: { ...typography.label, color: BRAND, fontWeight: '800' },
  mediaPreview: { width: '100%', height: 160, borderRadius: borderRadius.xl, backgroundColor: commonColors.surfaceAlt, marginTop: spacing.md },
  viewsTag: { flexDirection: 'row', alignItems: 'center', gap: 4, backgroundColor: commonColors.surfaceAlt, borderRadius: borderRadius.full, paddingHorizontal: 10, paddingVertical: 4 },
  statsCard: { backgroundColor: commonColors.surface, borderRadius: borderRadius.xl, padding: spacing.lg, marginBottom: spacing.lg, borderWidth: 1, borderColor: commonColors.borderLight, ...shadows.subtle },
  statsHeaderRow: { flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: spacing.md },
  statsTitle: { ...typography.h3, fontWeight: '800', color: commonColors.text, flex: 1 },
  statsTotal: { ...typography.label, fontWeight: '800', color: BRAND },
  statsEmpty: { ...typography.bodySm, color: commonColors.textTertiary },
  topRow: { flexDirection: 'row', alignItems: 'center', gap: spacing.md, paddingVertical: 8 },
  topRank: { ...typography.bodyLg, fontWeight: '800', color: BRAND, width: 24 },
  topTitle: { flex: 1, ...typography.bodyMd, color: commonColors.text, fontWeight: '600' },
});
